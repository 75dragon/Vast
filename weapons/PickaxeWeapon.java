...
public class PickaxeWeapon extends Weapon
{
	...
	public void attackAction()
	{
		...
		if (theWielder.getWorld().hitEnemiesInArea(theWielder.getX() + theWielder.getVX(),
				theWielder.getY() + theWielder.getVY(), .75, damage, weaponName))
		{
		...
		if (canAttack && wantToAttack)
		{
			...
			else
			{
				...
				theWielder.getWorld().addSprite(attackImg, theWielder.getX() + theWielder.getVX(),
						theWielder.getY() + theWielder.getVY(), .1);
			}
